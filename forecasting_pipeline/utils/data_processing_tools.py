...
def build_specific_ds(
    ...
    if mean_period[0] == 0:
        ...
        exog_Weather = exog[[x for x in exog.columns if x !="datetime"]].rolling(mean_period[0], closed="left").mean()
    ...
    if mean_period[1] == 0:
        ...
        exog_stau = exog[[x for x in exog.columns if x !="datetime"]].rolling(mean_period[1], closed="left").mean()
